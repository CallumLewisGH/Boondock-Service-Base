...
func RegisterUserRoutes(s *api.Server) {
	...
	s.Router.HandleFunc("/users/", CreateUser()).Methods(http.MethodPost)
}
...
// @Tags users
// @Produce json
// @Param name body models.UserApiRequest true "User" Format(models.UserApiRequest) Example(models.UserApiRequest)
// @Success 200 {} models.User
// @Router /users/ [post]
func CreateUser() http.HandlerFunc {
	handler := func(w http.ResponseWriter, r *http.Request) {
		model := api.DecodeJsonRequest(r, w, models.UserApiRequest{})
