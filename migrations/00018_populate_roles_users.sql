...
-- Insert users
INSERT INTO base.users (id, user_name, email, hash_salt, password_hash) VALUES
    ('f1eebc99-9c0b-4ef8-bb6d-6bb9bd380a18', 'admin_user', 'admin@example.com', 'salt1', 'hash1'),
    ('f2eebc99-9c0b-4ef8-bb6d-6bb9bd380a19', 'regular_user', 'user@example.com', 'salt2', 'hash2');
